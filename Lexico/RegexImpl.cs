...
namespace Lexico.RegexImpl
{
    ...
    public class Regex
    {
        ...
        public class Parser : ParserBase
        {
            ...
            public override void Compile(Context context) => _inner.Compile(context);
    ...
    public class Alternation
    {
        ...
        public IParser Create(IConfig config, ParserFlags flags) => Items.Count == 1 ? Items[0].Create(config, flags)
                                                                       : new AlternativeParser(typeof(void), config, flags, Items.Select(s => s.Create(config, flags)));
    }
